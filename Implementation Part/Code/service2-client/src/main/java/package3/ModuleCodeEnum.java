...
/**
 * <p>Java class for moduleCodeEnum.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * <p>
 * <pre>
 * &lt;simpleType name="moduleCodeEnum">
...
public enum ModuleCodeEnum {
    ...
    public static ModuleCodeEnum fromValue(String v) {
        for (ModuleCodeEnum c: ModuleCodeEnum.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
