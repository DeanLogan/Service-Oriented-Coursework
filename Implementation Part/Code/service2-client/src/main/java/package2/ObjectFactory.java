...
public class ObjectFactory {
    ...
    private final static QName _IOException_QNAME = new QName("http://package2/", "IOException");
    private final static QName _JAXBException_QNAME = new QName("http://package2/", "JAXBException");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://package2/", name = "IOException")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://package2/", name = "JAXBException")
