...
/**
 * <p>Java class for moduleCode1.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * <p>
 * <pre>
 * &lt;simpleType name="moduleCode1">
 ...
 * 
 */
@XmlType(name = "moduleCode1")
@XmlEnum
public enum ModuleCode1 {
    ...
    public static ModuleCode1 fromValue(String v) {
        for (ModuleCode1 c: ModuleCode1 .values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
